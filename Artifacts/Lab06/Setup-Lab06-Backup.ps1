...
$baseRepoUrl = "https://raw.githubusercontent.com/hoanggiathinh2002/SavacoSQLServer2025Lab/main/Artifacts/Lab06"
$labRoot = "C:\SQLServerAdminLabs\LabFiles\Lab06"
...
$setupFiles = @(
    ...
    [PSCustomObject]@{ Name = "InternetSales.mdf.txt"; Local = $setupFilesFolder; Remote = "Starter/Setupfiles" }
...
$solutionFiles = @(
    [PSCustomObject]@{ Name = "Restore AWDataWarehouse.sql"; Local = $solutionFolder; Remote = "Solution" }
    [PSCustomObject]@{ Name = "Restore HumanResources.sql"; Local = $solutionFolder; Remote = "Solution" }
    [PSCustomObject]@{ Name = "Restore InternetSales.sql"; Local = $solutionFolder; Remote = "Solution" }
)
...
Write-Output "Lesson 06 ($installType) Successfully Downloaded and Initialized."