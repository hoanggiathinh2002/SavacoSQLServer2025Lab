...
$solutionFiles = @(
    ...
    [PSCustomObject]@{ Name = "Create HumanResources.sql"; Local = $solutionFolder; Remote = "Solution" }
...
Write-Output "Lab 03 ($installType) Successfully Downloaded and Initialized."